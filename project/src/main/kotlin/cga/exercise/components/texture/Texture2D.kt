...
import org.lwjgl.opengl.ARBInternalformatQuery2.GL_VIEW_CLASS_S3TC_DXT1_RGBA
...
class Texture2D(imageData: ByteBuffer, width: Int, height: Int, genMipMaps: Boolean): ITexture{
    ...
    override fun processTexture(imageData: ByteBuffer, width: Int, height: Int, genMipMaps: Boolean) {
        ...
        GL30.glTexImage2D(GL_TEXTURE_2D, 0, GL30.GL_RGBA8, width, height, 0, GL30.GL_RGBA, GL30.GL_UNSIGNED_BYTE, imageData)
